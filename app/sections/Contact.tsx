...
const Contact = ({ whatsapp }: { whatsapp: string }) => {
  return (
    <section
      id="contact"
      className="mt-10 relative flex items-center justify-between  h-[600px] bg-[#8FC963]"
    >
      <iframe
      ...
      <div className="absolute z-20 top-16 right-24  bg-[#8FC963] p-7 rounded-md">
        ...
        <p className="text-[24px] py-6 max-w-[28rem]">
          هل لديك استفسار أو تحتاج إلى خدمة لسيارتك؟ نحن هنا لخدمتك!
        </p>
        <div className="flex flex-col gap-6 text-[18px]">
          <div className="flex items-center  gap-4">
            <Image src="/images/Location.svg" alt="phone" width={24} height={24} />
            <p className="text-white font-medium ">
              الرياض حي المنار طريق خريص مقابل مكتب العمل القديم
            </p>
          </div>
          <div className="flex items-center  gap-4">
          ...
          <div className="flex items-center  gap-4">
            <Image src="/images/Clock.svg" alt="phone" width={24} height={24} />
