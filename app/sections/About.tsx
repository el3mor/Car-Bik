    ...
    >
      ...
      <div id="details-section" className="flex flex-col  gap-10 ">
        <div className="flex flex-col gap-4">
          ...
          <h2 className="text-3xl font-bold text-[#8FC963]">كار بك - خبراء العناية بسيارتك!</h2>
        </div>
        <p className="text-[17px] font-medium max-w-[25rem]">
          في هوا كار بك، نقدم خدمات صيانة احترافية بأعلى معايير الجودة، لضمان أداء سيارتك بكفاءة
          وأمان. فريقنا من الخبراء يعمل بأحدث التقنيات لتوفير تجربة صيانة مريحة وموثوقة.
        </p>
        <div className="flex flex-col gap-4">
          <h3 className="text-xl font-bold text-[#8FC963]">رؤيتنا</h3>
          <p className="text-[17px] font-medium max-w-[25rem]">
            أن نكون الخيار الأول في المملكة العربية السعودية لخدمات صيانة السيارات، من خلال تقديم
            حلول مبتكرة، وخدمة عملاء استثنائية، وتقنيات متطورة تضمن أعلى معايير الجودة والأمان
            لسيارتك.
          </p>
        </div>
