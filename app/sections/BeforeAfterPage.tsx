...
const BeforeAfterPage = () => {
  return (
    <section className='py-32 2xl:px-32 overflow-x-hidden flex flex-col gap-28'>
      ...
      <p className="md:text-[24px] max-2xl:px-12 text-[15px] text-center max-w-[94rem]" >تقنية احترافية لإزالة الصدمات والخدوش بدون طلاء! شاهد الصور قبل وبعد لتكتشف كيف يمكننا إعادة سيارتك إلى حالتها الأصلية بدقة عالية وبدون أي أثر للصدمات</p>
      </div>
