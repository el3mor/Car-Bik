...
const Service = ({
  ...
  return (
    ...
    <div ref={serviceRef}>
    <Link href={`/services/${service.id}`} className='flex relative flex-col  h-[30rem]   gap-3 px-6 pt-4 pb-10 bg-gradient-to-b from-[rgba(250,249,246,0.2)] to-[rgba(250,249,246,0)] rounded-xl border-t-2 border-t-[#FAF9F6]
