...
const BlogCard = (
  ...
  return (
    ...
    <div ref={blogRef}>
    <Link href={`/blogs/${index}`} className='flex relative flex-col  gap-3 px-6 pt-4 pb-10 bg-gradient-to-b from-[rgba(250,249,246,0.2)] to-[rgba(250,249,246,0)] rounded-xl border-t-2 border-t-[#FAF9F6]
